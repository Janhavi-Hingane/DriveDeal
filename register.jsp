...
<!doctype html><html><head><title>Admin Register</title><link rel="stylesheet" href="assets/css/styles.css"></head>
<body>
<div class="nav"><a class="brand" href="${pageContext.request.contextPath}/">DriveDeal</a></div>
<div class="container"><div class="card" style="max-width:520px;margin:auto">
  <h2>Create Admin</h2>
